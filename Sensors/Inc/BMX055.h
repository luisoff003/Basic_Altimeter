...
typedef struct
{
    ...
    /* May code for quaternions later */

    /* Temperature data on °C */
    float temperature;
...
/** @function void BMX055_readAllSensors(I2C_HandleTypeDef *I2Cx, BMX055_t *DataStruct)
*   @brief Reads available data sensor from BMX055
*   @param[in] I2C_HandleTypeDef *I2Cx:    pointer to the I2C conection available on the uC
*   @param[in] BMX055_t *DataStruct: struct to store the data from BMX055
*   @return Function does not return anything maybe:
*           - 0: All data correct
*           - 1: Error data type.
*
* This function reads all sensors from the BMX055 and scale them to give attitude data on
* degrees.
*
*/
...
/** @function void getGyro_Res(void)
*   @brief Uses the written value to the sensor used to initialize the gyro.
*   @note This value shall be updated if any configuration on the sensor
*   is change.
*/
